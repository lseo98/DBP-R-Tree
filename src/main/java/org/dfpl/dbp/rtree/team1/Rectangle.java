...
/**
 * Rectangle 클래스: 직사각형을 표현하는 클래스
 * R-Tree에서 MBR (Minimum Bounding Rectangle)을 나타내는데 사용됩니다.
 *
 * MBR이란?
 * - 여러 개의 점이나 도형을 모두 포함하는 "최소 크기의 직사각형"
 * - R-Tree의 각 노드는 자신이 포함하는 데이터들의 MBR을 가집니다
 */
public class Rectangle {
	...
	// 이 두 점만 있으면 직사각형을 완전히 표현할 수 있습니다
	private Point leftTop;
	private Point rightBottom;

	/**
	 * 생성자: Rectangle 객체를 생성합니다
	 *
